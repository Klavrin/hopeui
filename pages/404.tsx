...
const Page404 = () => {
  const metaData = {
    heading: 'Oops! This Page is Not Found.',
    description: 'The requested page dose not exist'
  }

  return (
    <section className="bg-gradient-to-l from-primaryDark via-skyBlue to-primaryDark">
      <div className="w-screen h-screen lg:bg-[url('/assets/404.png')] bg-no-repeat bg-center flex flex-col justify-center items-center mx-auto">
...
// bg-gradient-to-l from-primaryDark via-skyBlue to-primaryDark
